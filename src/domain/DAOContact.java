...
public class DAOContact implements IDAOContact {
	 ...
	 */
	public Contact addContact(long idContact, String firstname,
	...
	public boolean modifyContact(long id, String firstname, String lastname,
		...
		try {
			...
			con = Database.connect();
			Statement stmt = con.createStatement();
			String sqlFirstName = "UPDATE contacts SET firstname = " + "'"
					+ firstname + "'" + " WHERE id = " + id;
			String sqlLastName = "UPDATE contacts SET lastname = " + "'"
					+ lastname + "'" + " WHERE id = " + id;
			String sqlEmail = "UPDATE contacts SET email = " + "'" + email
					+ "'" + " WHERE id = " + id;
	...
	public ArrayList<Contact> getContactByFirstName(String firstname) {
		...
		try {
			...
			con = Database.connect();
			Statement stmt = con.createStatement();
			rec = stmt.executeQuery("SELECT * FROM contacts WHERE firstname = "
					+ "'" + firstname + "'");
	...
	public ArrayList<Contact> getContactByLastName(String lastname) {
		...
		try {
			...
			con = Database.connect();
			Statement stmt = con.createStatement();
			rec = stmt.executeQuery("SELECT * FROM contacts WHERE lastname = "
					+ "'" + lastname + "'");
	...
	public ArrayList<Contact> getContactByEmail(String email) {
		...
		try {
			...
			con = Database.connect();
			Statement stmt = con.createStatement();
			rec = stmt.executeQuery("SELECT * FROM contacts WHERE email = "
					+ "'" + email + "'");
